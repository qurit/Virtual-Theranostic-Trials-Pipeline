...
class TdtPipeline:
    ...
    def run(self) -> Context:
        ...
        # --- Removed: separate TdtRoiUnifyStage call (merged into SegmentationStage) --- 
        ...
        # --- Removed: separate SimindPreprocessStage call (merged into SimindSimulationStage) --- 
        ...
        # --- Removed: Phase 4 Dosimetry section (OpenGATE moved to Phase 2) --- 
